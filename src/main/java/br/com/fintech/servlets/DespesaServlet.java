...
import br.com.fintech.controller.EditarDespesa;
import br.com.fintech.controller.RegistrarDespesa;
...
public class DespesaServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "registrarDespesa":
			RegistrarDespesa acaoRegistrar = new RegistrarDespesa();
			nome = acaoRegistrar.executar(request, response);
			break;
		case "editarDespesa": 
			EditarDespesa acaoEditar = new EditarDespesa();
